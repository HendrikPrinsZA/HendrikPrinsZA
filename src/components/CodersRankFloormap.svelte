<script>
  ...
  import data from '../../storage/data/tree-map.js'
...
<p>
  Based on <a href="https://observablehq.com/@d3/zoomable-treemap"
    >Zoomable Treemap by Mike Bostock</a
  >.
</p>
